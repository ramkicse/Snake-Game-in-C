...
#include<alloc.h>
#include<process.h>
int x[100],y[100],x2[500],y2[500],row=0,col=0,i=5,j,set=0,dupli,p,bb=5,aaa=1;
union REGS in,o;
int button,n,m;
struct time t;
int ro,co,xc1=0,yc1=0,bon=0,xc=0,yc=0,v,are,level=1,score=0,zzz=50,ddd=0;
char *buff,*f1,*f2,*st1,name[15];
ra()
{
	setcolor(14);
	settextstyle(0,0,1);
...
void main()
{
	int sss,q,ll,gd=DETECT,p,gm,area,a=(450-(50*5)),s=0,d,cat=77,ch,dh,eh,t1,t2,t12,t22,len,cc,hh;
	char *str,*str1,*tim;
	initgraph(&gd,&gm,"");
	p=1;
	front();
...
int speed()
{
int a,dd,xxx=99+(50*4),ii,tt=0,count;
char *stt;
	setpos(0,0);
	viewport();
	count=zzz;
...
int secondMenu()
{
	char *men[]={"Mazes","Speed Level","Top Scorer List","Back"};
	int w=0,k,g=130,h=200;
	setpos(0,0);
	viewport();
	setcolor(8);
